...
/* harmony export */   "BLANK_CARD": () => (/* binding */ BLANK_CARD),
/* harmony export */   "CARD_MODE": () => (/* binding */ CARD_MODE),
/* harmony export */   "COLORS": () => (/* binding */ COLORS),
/* harmony export */   "DESCRIPTIONS": () => (/* binding */ DESCRIPTIONS),
/* harmony export */   "MAX_DAYS_GAP": () => (/* binding */ MAX_DAYS_GAP),
...
class DataBase {
    constructor() {
        this.db = new dexie__WEBPACK_IMPORTED_MODULE_0__["default"]("toDoDataBase");
...
/* harmony export */ });
/* harmony import */ var _view_board_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/board.js */ "./src/view/board.js");
/* harmony import */ var _view_main_menu_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/main-menu.js */ "./src/view/main-menu.js");
/* harmony import */ var _view_cards_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/cards-list.js */ "./src/view/cards-list.js");
/* harmony import */ var _view_empty_list_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/empty-list.js */ "./src/view/empty-list.js");
/* harmony import */ var _utils_common_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/common.js */ "./src/utils/common.js");
/* harmony import */ var _presenter_card_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../presenter/card.js */ "./src/presenter/card.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _view_filter_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../view/filter.js */ "./src/view/filter.js");
/* harmony import */ var _utils_card_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../utils/card.js */ "./src/utils/card.js");
...
class BoardPresenter {
  constructor(boardContainer, filters, siteHeaderElement, db) {
    ...
    this._boardComponent = new _view_board_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._siteHeaderElement = siteHeaderElement;
    this._siteHeaderComponent = new _view_main_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"]();
    this._filterComponent = new _view_filter_js__WEBPACK_IMPORTED_MODULE_7__["default"](filters);
    this._cardsListComponent = new _view_cards_list_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    this._emptyListComponent = new _view_empty_list_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._cardPresenter = {};
  ...
  init(boardCards) {
    ...
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this._siteHeaderElement, this._siteHeaderComponent);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this._boardContainer, this._boardComponent);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this._boardComponent, this._cardsListComponent);
  ...
  _renderFilter() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this._boardComponent, this._filterComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__.RenderPosition.afterBegin);
    this._filterComponent.setFilterChangeHandler();
  }

  _renderCard(card) {
    const cardPresenter = new _presenter_card_js__WEBPACK_IMPORTED_MODULE_5__["default"](this._cardsListComponent, this._handleCardChange, this._handleModeChange, this.db);
  ...
  _renderEmptyList() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.render)(this._boardComponent, this._emptyListComponent);
  }

  _removeEmptyList() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_6__.remove)(this._emptyListComponent);
  }
  ...
  _handleCardChange(updatedCard) {
    this._boardCards = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_4__.updateItem)(this._boardCards, updatedCard);
  ...
  _addEditCard() {
    ...
    const cardPresenter = new _presenter_card_js__WEBPACK_IMPORTED_MODULE_5__["default"](this._cardsListComponent, this._handleCardChange, this._handleModeChange);
    const newCardData = {
      id: (0,_utils_card_js__WEBPACK_IMPORTED_MODULE_8__.generateId)(),
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CardPresenter)
/* harmony export */ });
/* harmony import */ var _view_card_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/card.js */ "./src/view/card.js");
/* harmony import */ var _view_edit_card_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/edit-card.js */ "./src/view/edit-card.js");
...
class CardPresenter {
  ...
  init(card, newCardMode = false) {
    ...
    this._cardComponent = new _view_card_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._card);
    this._editCardComponent = new _view_edit_card_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._card);
    ...
    if (newCardMode) {
      this._mode = _const_js__WEBPACK_IMPORTED_MODULE_3__.CARD_MODE.EDIT;
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this._cardsListContainer, this._editCardComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__.RenderPosition.afterBegin);
      return;
    } else if (prevCardComponent === null || prevEditCardComponent === null) {
      this._mode = _const_js__WEBPACK_IMPORTED_MODULE_3__.CARD_MODE.DEFAULT;
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(this._cardsListContainer, this._cardComponent);
      return;
    }

    if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__.CARD_MODE.DEFAULT) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._cardComponent, prevCardComponent);
    }

    if (this._mode === _const_js__WEBPACK_IMPORTED_MODULE_3__.CARD_MODE.EDIT) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._editCardComponent, prevEditCardComponent);
    }

    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(prevCardComponent);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(prevEditCardComponent);
  }

  destroy() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this._cardComponent);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.remove)(this._editCardComponent);
  }
  ...
  _replaceFormToCard() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._cardComponent, this._editCardComponent);
  ...
  _replaceCardToForm() {
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.replace)(this._editCardComponent, this._cardComponent);
...
/* harmony export */   "shortTaskDueDate": () => (/* binding */ shortTaskDueDate)
/* harmony export */ });
const shortTaskDueDate = (dueDate) => {
...
class BoardView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
/* harmony export */ });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_card_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/card.js */ "./src/utils/card.js");
    ...
    return (
      `<article class="card card--${color} card--${isArchive?'archive':'current'}" id="${id}">
        <div class="card__title">${title}</div>
          <div class="card__date-holder">Выполнить до: <span class="card__date-text">${(0,_utils_card_js__WEBPACK_IMPORTED_MODULE_1__.shortTaskDueDate)(dueDate)}</span></div>
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ CardsListView)
/* harmony export */ });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");


class CardsListView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ EditCardView)
/* harmony export */ });
...
/* harmony import */ var _utils_card_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/card.js */ "./src/utils/card.js");




class EditCardView extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(card = _const_js__WEBPACK_IMPORTED_MODULE_1__.BLANK_CARD) {
    super();
          ...
          <div class="card__settings">
            <div class="card__dates">
                ...
                <input class="card__date" type="date" id="deadline" name="deadline"
                       value="${(0,_utils_card_js__WEBPACK_IMPORTED_MODULE_2__.shortTaskDueDate)(dueDate)}"></label>
            </div>
            <div class="card__colors-inner">
              <div class="card__colors-title">Цветовой маркер</div>
              <div class="card__colors-wrap">
                ${_const_js__WEBPACK_IMPORTED_MODULE_1__.COLORS.map((colorItem) => `
                  <input
                    type="radio"
                    id="color-${colorItem}"
...
class EmptyListView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
...
class FilterView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters) {
    super();
...
class FooterView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
    return (
      `<footer class="footer">
...
class MainMenuView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
...
class SmartView extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  restoreHandlers() {
    throw new Error(`Ошибка абстрактного метода`);
  }
}
...
/*!*********************!*\
  ...
  \*********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _view_footer_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./view/footer.js */ "./src/view/footer.js");
...
/* harmony import */ var _model_card_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./model/card.js */ "./src/model/card.js");
...
const db = new _model_card_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
db.getTasks().then(function (cards){
    const filters = (0,_utils_filter_js__WEBPACK_IMPORTED_MODULE_1__.generateFilter)(cards);
    ...
    const boardPresenter = new _presenter_board_js__WEBPACK_IMPORTED_MODULE_3__["default"](siteMainElement, filters, siteHeaderElement, db);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_2__.render)(siteFooterElement, new _view_footer_js__WEBPACK_IMPORTED_MODULE_0__["default"]());
